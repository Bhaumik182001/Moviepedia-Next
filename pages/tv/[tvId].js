...
export async function getServerSideProps(context){
    ...
    const cast = await fetch(`https://api.themoviedb.org/3/tv/${mediaId}/credits?api_key=${process.env.API_KEY}&language=en-US`).then(res => res.json()).then(res => res.cast)
    const trailer = await fetch(`https://api.themoviedb.org/3/tv/${mediaId}/videos?api_key=${process.env.API_KEY}`).then(res=>res.json()).then(res => res.results)
    const recommended = await fetch(`https://api.themoviedb.org/3/tv/${mediaId}/recommendations?api_key=${process.env.API_KEY}&language=en-US&page=1`).then(res=>res.json()).then(res => res.results)
